...
<template>
  <div class="title">
    <h1>猜你喜欢 <span><img src="https://gw.alicdn.com/imgextra/i2/O1CN016b1mMM1FxJlsXfWhU_!!6000000000553-2-tps-96-30.png" alt=""></span></h1>
  </div>
  <div class="pic" v-infinite-scroll="load">
    <li v-for="(item,index) in goodlist.slice(0, count)" :key="item.index" class="infinite-list-item">
